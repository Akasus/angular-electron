...
electron_1.contextBridge.exposeInMainWorld('api', {
    ...
    openWin: (title) => electron_1.ipcRenderer.invoke('open-win', { title: title }),
    getData: (key) => electron_1.ipcRenderer.invoke("get-data", key),
    getLog: (page, query) => electron_1.ipcRenderer.invoke('get-log', page, query),
});
electron_1.contextBridge.exposeInMainWorld('noteContent', {
